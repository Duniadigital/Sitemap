 ...
 * Modified by Duniadigital.net
 * URL: http://gplus.to/duniadigital
 * ---------------------------------------------------
 */
...
var toc_config = {
	...
	showNew: 10,
	newText: ' <strong style="font-weight:normal;font-style:normal;color:#fff;font-size:15px;background:#5c5a78;padding:1px 6px 3px 6px;line-height:normal;float:right;border-radius:3px;">baru</strong>',
	sortAlphabetically: {
		thePanel: true,
		theList: true
	},
